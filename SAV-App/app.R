...
ui <- fluidPage(
  ...
  #   tags$img(src = "DNR_logo_final.png", height = "20px")
  # ),
  # hr(),
  fluidRow(
    column(width = 12,
  ...
  fluidRow(
    ...
    column(width = 7,
           card(p("Segment Map", align="center"),
                leafletOutput("SegmentMap", height="525px"))
    )
   ),
  br(),
